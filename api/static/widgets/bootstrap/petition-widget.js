...
var author$project$Main$init = function (params) {
	...
	return _Utils_Tuple2(
		author$project$Widget$Common$initModel(params),
		A2(
			elm$http$Http$send,
			author$project$Widget$Common$GotPetition,
			A3(
...
var author$project$Widget$Common$CloseMsg = {$: 'CloseMsg'};
var author$project$Widget$Common$ShowFullTextMsg = {$: 'ShowFullTextMsg'};
var author$project$Widget$Common$SignPetitionMsg = {$: 'SignPetitionMsg'};
				...
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							_Utils_ap(
								mm(author$project$Widget$Common$SignPetitionMsg),
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$text(
															mm(author$project$Widget$Common$CloseMsg))
														]))
												]))
										]))
								]))
...
var author$project$Widget$Common$PeopleMsg = {$: 'PeopleMsg'};
							...
							[
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										mm(author$project$Widget$Common$PeopleMsg))))
							]))
					]));
		} else {
...
var author$project$Main$view = function (model) {
	var mm = author$project$Widget$Common$m(model.locale);
	var _n0 = model.petitionStatus;
	switch (_n0.$) {
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						A4(author$project$Main$viewPetition, model.url, model.code, model.locale, pModel.petition),
						function () {
						var _n1 = model.formStatus;
						switch (_n1.$) {
							case 'Sending':
							...
							default:
								return A2(
									...
									_List_fromArray(
										[
											A2(author$project$Main$viewSignersCount, model.locale, pModel.signersCount),
											A2(
											elm$html$Html$map,
											author$project$Widget$Common$FormMsg,
											A2(author$project$Main$formView, model.locale, model.formData))
										]));
						}
					}()
					]));
		...
		return elm$http$Http$request(
			{
				...
				expect: elm$http$Http$expectJson(elm$json$Json$Decode$int),
				headers: _List_Nil,
				method: 'POST',
				timeout: elm$core$Maybe$Nothing,
				url: A2(
...
var author$project$Main$main = elm$browser$Browser$element(
	{init: author$project$Main$init, subscriptions: author$project$Main$subscriptions, update: author$project$Widget$Common$update, view: author$project$Main$view});
